...
int DatabaseLayer::GetSingleResultInt(const wxString& strSQL, const wxString& strField)
{
  wxVariant variant(strField);
  return GetSingleResultInt(strSQL, &variant);
}

int DatabaseLayer::GetSingleResultInt(const wxString& strSQL, int nField)
{
  wxVariant variant((long)nField);
  return GetSingleResultInt(strSQL, &variant);
}

int DatabaseLayer::GetSingleResultInt(const wxString& strSQL, const wxVariant* field)
{
...
wxString DatabaseLayer::GetSingleResultString(const wxString& strSQL, int nField)
{
  wxVariant variant((long)nField);
  return GetSingleResultString(strSQL, &variant);
}

wxString DatabaseLayer::GetSingleResultString(const wxString& strSQL, const wxString& strField)
{
  wxVariant variant(strField);
  return GetSingleResultString(strSQL, &variant);
}

wxString DatabaseLayer::GetSingleResultString(const wxString& strSQL, const wxVariant* field)
{
  bool valueRetrievedFlag = false;
...
long DatabaseLayer::GetSingleResultLong(const wxString& strSQL, int nField)
{
  wxVariant variant((long)nField);
  return GetSingleResultLong(strSQL, &variant);
}

long DatabaseLayer::GetSingleResultLong(const wxString& strSQL, const wxString& strField)
{
  wxVariant variant(strField);
  return GetSingleResultLong(strSQL, &variant);
}

long DatabaseLayer::GetSingleResultLong(const wxString& strSQL, const wxVariant* field)
{
  bool valueRetrievedFlag = false;
  long value = -1;
...
bool DatabaseLayer::GetSingleResultBool(const wxString& strSQL, int nField)
{
  wxVariant variant((long)nField);
  return GetSingleResultBool(strSQL, &variant);
}

bool DatabaseLayer::GetSingleResultBool(const wxString& strSQL, const wxString& strField)
{
  wxVariant variant(strField);
  return GetSingleResultBool(strSQL, &variant);
}

bool DatabaseLayer::GetSingleResultBool(const wxString& strSQL, const wxVariant* field)
{
  bool valueRetrievedFlag = false;
  bool value = false;
...
wxDateTime DatabaseLayer::GetSingleResultDate(const wxString& strSQL, int nField)
{
  wxVariant variant((long)nField);
  return GetSingleResultDate(strSQL, &variant);
}

wxDateTime DatabaseLayer::GetSingleResultDate(const wxString& strSQL, const wxString& strField)
{
  wxVariant variant(strField);
  return GetSingleResultDate(strSQL, &variant);
}

wxDateTime DatabaseLayer::GetSingleResultDate(const wxString& strSQL, const wxVariant* field)
{
  bool valueRetrievedFlag = false;
...
void* DatabaseLayer::GetSingleResultBlob(const wxString& strSQL, int nField, wxMemoryBuffer& Buffer)
{
  wxVariant variant((long)nField);
  return GetSingleResultBlob(strSQL, &variant, Buffer);
}

void* DatabaseLayer::GetSingleResultBlob(const wxString& strSQL, const wxString& strField, wxMemoryBuffer& Buffer)
{
  wxVariant variant(strField);
  return GetSingleResultBlob(strSQL, &variant, Buffer);
}

void* DatabaseLayer::GetSingleResultBlob(const wxString& strSQL, const wxVariant* field, wxMemoryBuffer& Buffer)
{
  bool valueRetrievedFlag = false;
  void* value = NULL;
...
double DatabaseLayer::GetSingleResultDouble(const wxString& strSQL, int nField)
{
  wxVariant variant((long)nField);
  return GetSingleResultDouble(strSQL, &variant);
}

double DatabaseLayer::GetSingleResultDouble(const wxString& strSQL, const wxString& strField)
{
  wxVariant variant(strField);
  return GetSingleResultDouble(strSQL, &variant);
}

double DatabaseLayer::GetSingleResultDouble(const wxString& strSQL, const wxVariant* field)
{
  bool valueRetrievedFlag = false;
  double value = -1;
